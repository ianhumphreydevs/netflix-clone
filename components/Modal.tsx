        ...
        <div className="relative pt-[56.25%]">
          ...
          <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
            <div className="flex space-x-2">
              ...
              text-xl font-bold text-balance transition hover:bg-[#e6e6e6] text-black"
              >
        ...
        <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8">
          <div className="space-y-6 text-lg">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <div
                className="flex h-4 items-center justify-center rounded border-white/40
                    px-1.5 text-sm"
              >
                HD
              </div>
            </div>
            <div className="overview flex flex-col gap-x-10 gap-y-4 font-light md:flex-row">
              <p className="overview__para w-5/6">{movie?.overview}</p>
